...
describe('categories.db', () => {
    ...
    it('createCategory creates a new category', async () => {
        ...
        prisma.categories.create.mockResolvedValue(createdCategory);
    ...
    it('deleteCategory deletes a category', async () => {
        prisma.categories.delete.mockResolvedValue(undefined);
        await expect(categoriesDb.deleteCategory('category-1')).resolves.toBeUndefined();
